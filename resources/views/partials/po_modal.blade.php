...
<div class="modal fade bs-example-modal-lg create-po-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="background-color:#fff;">
     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="color: #fff;">&times;</span></button>

     <input type="hidden" id="numberOfItem" value="" />
...
<div class="table-responsive" style="padding:10px;">
   <table class="table table-bordered">
    ...
    <div id="loading">
          <img id="poLoading-image" style="display:none;" src="{{ asset('promed_admin/assets/img/loading2.gif') }}" alt="Loading..." />
    </div>
