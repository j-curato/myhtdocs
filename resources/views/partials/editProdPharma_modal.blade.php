<div class="modal fade bs-example-modal-lg edit-prodPharma-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="background-color: #343D46;">
     <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="color: #fff;">&times;</span></button>
            ...
            <address></address>
            <input type="hidden" id="pharmaTxtVal" value="Pharma" />
            <form class="form-horizontal edit-prod-form" id="edit-prod-form" method="POST" style="background-color: #e2e2e2;" >
              ...
              <fieldset>
                ...
                <div id="loading">
                  <img id="updatePharma-loading-image" style="display:none;" src="{{ asset('promed_admin/assets/img/loading2.gif') }}" alt="Loading..." />
                </div>
