...
@include('partials.editprod_modal')
...
<div id="page-wrapper" >
    ...
    @endif
        ...
        <div class="row">
             <div class="col-md-12">
                <h2 style="color:#000;">Product Registration Page - Medical & Lab. Supplies</h2>    
                <span style="display:none;" id="pageTxt">Medical</span>  
             </div>
         </div>
       ...
       <!-- /. ROW  -->
        <hr />
               ...
               <?php $pendingpo_counter = App\PurchaseOrder\PurchaseOrder::where('add_toInventory_status', 0)->count(); ?>
                ...
                <a style="font-weight:normal;" href="{{-- url('add_product') --}}" class="btn btn-default add-prod-btn active"><i class="glyphicon glyphicon-plus"></i> Add Product</a>
                ...
                <a style="font-weight:normal;" href="{{ url('exportProduct') }}" class="btn btn-success btn-export-prod active" id="export-prod-id"><i class="glyphicon glyphicon-download"></i> Export to Excel</a>
               
                <!--<a href="{{ url('purchaseorders') }}"  class="btn btn-primary btn-load_updates active" target="_blank"><i class="glyphicon glyphicon-refresh"></i> Load updates</a>-->
        
                <div style="float:right;">
                  <a href="{{url('pharma')}}" class="btn btn-success btn-xs active">Pharma</a>    
                  <a href="{{url('products')}}" class="btn btn-success btn-xs disabled">Medical & Lab. Supplies</a>
                </div>  
               </div>
